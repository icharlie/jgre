...
public class GREView extends FrameView {
  ...
  /**
   * After updating or setting database, other componenets have to call this method
   */
  ...
  private void checkDigit(KeyEvent evt) throws NumberFormatException, HeadlessException {
    char key = evt.getKeyChar();
    JTextField textField = (JTextField) evt.getSource();
    if ((key >= KeyEvent.VK_A && key <= KeyEvent.VK_Z) || (key >= 97 && key <= 122)) {
      //檢查是否為數字
      textField.setText("4");
      JOptionPane.showMessageDialog(this.getFrame(), "請輸入1~10的數字", "注意！", JOptionPane.WARNING_MESSAGE);
    }
  ...
  private void initComponents() {
    ...
    ResourceMap resourceMap = Application.getInstance(GREApp.class).getContext().getResourceMap(GREView.class);
    ...
    showVerbalPanelLayout.setHorizontalGroup(
      ...
      .add(GroupLayout.TRAILING, showVerbalPanelLayout.createSequentialGroup()
        .add(30, 30, 30)
        .add(showVerbalPanelLayout.createParallelGroup(GroupLayout.LEADING)
          .add(verbalLabel, GroupLayout.PREFERRED_SIZE, 115, GroupLayout.PREFERRED_SIZE)
          .add(explainLabel, GroupLayout.DEFAULT_SIZE, 141, Short.MAX_VALUE))
        .addPreferredGap(LayoutStyle.RELATED)
        .add(showVerbalPanelLayout.createParallelGroup(GroupLayout.TRAILING)
          .add(showExplainLabel, GroupLayout.DEFAULT_SIZE, 530, Short.MAX_VALUE)
          .add(showVerbalLabel, GroupLayout.DEFAULT_SIZE, 530, Short.MAX_VALUE))
        .add(20, 20, 20))
    );
    showVerbalPanelLayout.setVerticalGroup(
      showVerbalPanelLayout.createParallelGroup(GroupLayout.LEADING)
      .add(showVerbalPanelLayout.createSequentialGroup()
        .add(showVerbalPanelLayout.createParallelGroup(GroupLayout.BASELINE)
          .add(showVerbalLabel, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)
          .add(verbalLabel, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE))
        .add(45, 45, 45)
        .add(showVerbalPanelLayout.createParallelGroup(GroupLayout.BASELINE)
          .add(explainLabel, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)
    ...
    memoPanelLayout.setHorizontalGroup(
      ...
      .add(memoPanelLayout.createSequentialGroup()
        .add(memoPanelLayout.createParallelGroup(GroupLayout.LEADING)
          .add(memoPanelLayout.createSequentialGroup()
            .add(219, 219, 219)
            .add(manualPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
          .add(controlPanel, GroupLayout.DEFAULT_SIZE, 729, Short.MAX_VALUE)
          .add(buttonPanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
          .add(showVerbalPanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        .addContainerGap())
    );
    ...
    maintainUnitMenuItem.setText(resourceMap.getString("maintainUnitMenuItem.text")); // NOI18N
...
//    playControlPanel.setVisible(showPlayControlPanel.isSelected() ? true : false);
  ...
  /**
   * When user click stop button or it has done a circle of the unit, the method
   * support to initialize the application state.
   * 
   */
  ...
  /**
   * set forgetbulCheckBox enable or unenable depend by this unit has forgetful vocabularies.
   */
  ...
  class VerbalWorker extends SwingWorker {
    ...
    protected Object doInBackground() throws Exception {
      while (!isCancelled()) {
        ...
        // show the index of the word that was be showed and total number 顯示目前已播放字彙數和字彙總量
        statusMessageLabel.setText(String.valueOf((index + 1)).concat("/").concat(String.valueOf(total)));
