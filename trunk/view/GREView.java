...
public class GREView extends FrameView {
  ...
  @Action
  public void showAddUnitBox() {
    if (addUnitBox == null) {
      JFrame mainFrame = GREApp.getApplication().getMainFrame();
      addUnitBox = new GREAddUnitBox(mainFrame, this);
      addUnitBox.setLocationRelativeTo(mainFrame);
    }
    GREApp.getApplication().show(addUnitBox);
  }
 
  @Action
  public void showDeleteUnitBox() {
    if (deleteUnitBox == null) {
      JFrame mainFrame = GREApp.getApplication().getMainFrame();
      deleteUnitBox = new GREDeleteUnitBox(mainFrame);
      deleteUnitBox.setLocationRelativeTo(mainFrame);
    }
    GREApp.getApplication().show(deleteUnitBox);
  ...
  private void checkDigit(KeyEvent evt) throws NumberFormatException,
    ...
    if ((key >= KeyEvent.VK_A && key <= KeyEvent.VK_Z) || (key >= 97 && key <= 122)) {
      // 檢查是否為數字
      textField.setText("4");
  ...
  private void initComponents() {
    ...
    ActionMap actionMap = Application.getInstance(GREApp.class).getContext().getActionMap(GREView.class, this);
    ...
    deleteUnitMenuItem = new JMenuItem();
    addUnitMenuItem = new JMenuItem();
    ...
    ResourceMap resourceMap = Application.getInstance().getContext().getResourceMap(GREView.class);
    ...
    statusPanelLayout.setHorizontalGroup(
      ...
      .add(GroupLayout.TRAILING, statusPanelLayout.createSequentialGroup()
        ...
        .add(statusMessageLabel, GroupLayout.PREFERRED_SIZE, 92, GroupLayout.PREFERRED_SIZE)
        .add(11, 11, 11))
    );
    statusPanelLayout.setVerticalGroup(
      statusPanelLayout.createParallelGroup(GroupLayout.LEADING)
      .add(statusPanelLayout.createSequentialGroup()
        .add(statusMessageLabel, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE)
    ...
    Binding binding = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, manualCheckbox, ELProperty.create("${!selected}"), verbalSpeedSlider, BeanProperty.create("enabled"));
    ...
    binding = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, verbalSpeedSlider, ELProperty.create("${value}"), verbalSpeedText, BeanProperty.create("text"));
    bindingGroup.addBinding(binding);
    binding = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, manualCheckbox, ELProperty.create("${!selected}"), verbalSpeedText, BeanProperty.create("enabled"));
    bindingGroup.addBinding(binding);
    ...
    binding = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, explainSpeedSlider, ELProperty.create("${value}"), explainSpeedText, BeanProperty.create("text"));
    bindingGroup.addBinding(binding);
    binding = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, manualCheckbox, ELProperty.create("${!selected}"), explainSpeedText, BeanProperty.create("enabled"));
    bindingGroup.addBinding(binding);
    ...
    verbalSpeedLabel.setText(resourceMap.getString("verbalSpeedLabel.text")); // NOI18N
    verbalSpeedLabel.setHorizontalTextPosition(SwingConstants.LEFT);
    verbalSpeedLabel.setName("verbalSpeedLabel"); // NOI18N

    explainSpeedLabel.setFont(resourceMap.getFont("explainSpeedLabel.font")); // NOI18N
    explainSpeedLabel.setText(resourceMap.getString("explainSpeedLabel.text")); // NOI18N
    ...
    playControlPanel.setBorder(BorderFactory.createTitledBorder(resourceMap.getString("playControlPanel.border.title"))); // NOI18N
    ...
    manualCheckbox.setAction(actionMap.get("setExplainSpeedState"));
    ...
    explainInTimeCheckBox.setAction(actionMap.get("setExplainSpeedState"));
    explainInTimeCheckBox.setFont(resourceMap.getFont("explainInTimeCheckBox.font")); // NOI18N
    explainInTimeCheckBox.setText(resourceMap.getString("explainInTimeCheckBox.text")); // NOI18N
    ...
    controlPanelLayout.setHorizontalGroup(
      ...
      .add(controlPanelLayout.createSequentialGroup()
        ...
        .add(controlPanelLayout.createParallelGroup(GroupLayout.LEADING)
          .add(controlPanelLayout.createSequentialGroup()
            .add(controlPanelLayout.createParallelGroup(GroupLayout.LEADING)
              .add(unitCombobox, GroupLayout.PREFERRED_SIZE, 160, GroupLayout.PREFERRED_SIZE)
              .add(controlPanelLayout.createSequentialGroup()
                .add(startSpinner, GroupLayout.PREFERRED_SIZE, 70, GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(LayoutStyle.RELATED)
                .add(contactLabel)
                .addPreferredGap(LayoutStyle.RELATED)
                .add(endSpinner, GroupLayout.PREFERRED_SIZE, 70, GroupLayout.PREFERRED_SIZE)))
            .add(134, 134, 134)
            .add(controlPanelLayout.createParallelGroup(GroupLayout.LEADING)
              .add(explainSpeedLabel)
              .add(verbalSpeedLabel))
            .addPreferredGap(LayoutStyle.RELATED)
            .add(controlPanelLayout.createParallelGroup(GroupLayout.LEADING)
              .add(explainSpeedSlider, GroupLayout.PREFERRED_SIZE, 134, GroupLayout.PREFERRED_SIZE)
              .add(verbalSpeedSlider, GroupLayout.PREFERRED_SIZE, 134, GroupLayout.PREFERRED_SIZE))
            .add(18, 18, 18)
            .add(controlPanelLayout.createParallelGroup(GroupLayout.LEADING, false)
              .add(verbalSpeedText, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)
              .add(explainSpeedText, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)))
          .add(playControlPanel, GroupLayout.PREFERRED_SIZE, 628, GroupLayout.PREFERRED_SIZE))
        .addContainerGap(9, Short.MAX_VALUE))
    );
    controlPanelLayout.setVerticalGroup(
      controlPanelLayout.createParallelGroup(GroupLayout.LEADING)
      .add(GroupLayout.TRAILING, controlPanelLayout.createSequentialGroup()
        .addContainerGap()
        .add(controlPanelLayout.createParallelGroup(GroupLayout.LEADING)
          .add(GroupLayout.TRAILING, controlPanelLayout.createSequentialGroup()
            .add(verbalSpeedText, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
            .add(9, 9, 9)
            .add(explainSpeedText, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
          .add(GroupLayout.TRAILING, controlPanelLayout.createSequentialGroup()
            .add(controlPanelLayout.createParallelGroup(GroupLayout.TRAILING)
              .add(verbalSpeedLabel)
              .add(verbalSpeedSlider, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
            .addPreferredGap(LayoutStyle.RELATED)
            .add(controlPanelLayout.createParallelGroup(GroupLayout.LEADING)
              .add(explainSpeedSlider, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
              .add(explainSpeedLabel)))
          .add(controlPanelLayout.createSequentialGroup()
            .add(unitCombobox, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE)
            .addPreferredGap(LayoutStyle.RELATED)
            .add(controlPanelLayout.createParallelGroup(GroupLayout.BASELINE)
              .add(startSpinner, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
              .add(contactLabel)
              .add(endSpinner, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
            .add(14, 14, 14)))
        .addPreferredGap(LayoutStyle.RELATED, 24, Short.MAX_VALUE)
        .add(playControlPanel, GroupLayout.PREFERRED_SIZE, 73, GroupLayout.PREFERRED_SIZE)
        .addContainerGap())
    );

    binding = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, showPlayControlPanelMenuItem, ELProperty.create("${selected}"), playControlPanel, BeanProperty.create("visible"));
    bindingGroup.addBinding(binding);
    ...
    pauseButton.setActionCommand(resourceMap.getString("pauseButton.actionCommand")); // NOI18N
    ...
    binding = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, manualCheckbox, ELProperty.create("${!selected}"), pauseButton, BeanProperty.create("visible"));
    bindingGroup.addBinding(binding);
    binding = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, manualCheckbox, ELProperty.create("${selected}"), nextButton, BeanProperty.create("visible"));
    bindingGroup.addBinding(binding);

    showVerbalPanel.setName("showVerbalPanel"); // NOI18N

    showExplainLabel.setFont(resourceMap.getFont("explainLabel.font")); // NOI18N
    showExplainLabel.setHorizontalAlignment(SwingConstants.CENTER);
    showExplainLabel.setText(resourceMap.getString("showExplainLabel.text")); // NOI18N
    ...
    showVerbalLabel.setHorizontalAlignment(SwingConstants.CENTER);
    ...
    showVerbalPanelLayout.setHorizontalGroup(
      showVerbalPanelLayout.createParallelGroup(GroupLayout.LEADING)
      .add(showVerbalPanelLayout.createSequentialGroup()
        .addContainerGap()
        .add(showVerbalPanelLayout.createParallelGroup(GroupLayout.LEADING)
          .add(showExplainLabel, GroupLayout.DEFAULT_SIZE, 637, Short.MAX_VALUE)
          .add(showVerbalLabel, GroupLayout.DEFAULT_SIZE, 637, Short.MAX_VALUE)))
    );
    showVerbalPanelLayout.setVerticalGroup(
      showVerbalPanelLayout.createParallelGroup(GroupLayout.LEADING)
      .add(showVerbalPanelLayout.createSequentialGroup()
        .add(showVerbalLabel, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)
        .add(45, 45, 45)
        .add(showExplainLabel, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)
    ...
    memoPanelLayout.setHorizontalGroup(
      memoPanelLayout.createParallelGroup(GroupLayout.LEADING)
      .add(GroupLayout.TRAILING, memoPanelLayout.createSequentialGroup()
        .add(memoPanelLayout.createParallelGroup(GroupLayout.TRAILING)
          .add(GroupLayout.LEADING, showVerbalPanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
          .add(GroupLayout.LEADING, buttonPanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
          .add(GroupLayout.LEADING, controlPanel, GroupLayout.DEFAULT_SIZE, 657, Short.MAX_VALUE))
        .add(manualPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        .add(26, 26, 26))
    );
    memoPanelLayout.setVerticalGroup(
      memoPanelLayout.createParallelGroup(GroupLayout.LEADING)
      .add(memoPanelLayout.createSequentialGroup()
        .add(controlPanel, GroupLayout.PREFERRED_SIZE, 208, GroupLayout.PREFERRED_SIZE)
        .add(18, 18, 18)
        .add(showVerbalPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
    ...
    activeTabPanel.addTab(resourceMap.getString("memoPanel.TabConstraints.tabTitle"), memoPanel); // NOI18N
    ...
    environmentMenuItem.setText(resourceMap.getString("environmentMenuItem.text")); // NOI18N
    environmentMenuItem.setName("environmentMenuItem"); // NOI18N
    toolMenu.add(environmentMenuItem);

    deleteUnitMenuItem.setAction(actionMap.get("showDeleteUnitBox"));
    deleteUnitMenuItem.setText(resourceMap.getString("deleteUnitMenuItem.text")); // NOI18N
    deleteUnitMenuItem.setName("deleteUnitMenuItem"); // NOI18N
    toolMenu.add(deleteUnitMenuItem);
    
    addUnitMenuItem.setAction(actionMap.get("showAddUnitBox"));
    addUnitMenuItem.setText(resourceMap.getString("addUnitMenuItem.text")); // NOI18N
    addUnitMenuItem.setName("addUnitMenuItem"); // NOI18N
    toolMenu.add(addUnitMenuItem);

    showPlayControlPanelMenuItem.setSelected(true);
    showPlayControlPanelMenuItem.setText(resourceMap.getString("showPlayControlPanelMenuItem.text")); // NOI18N
  ...
  private void manulShowVerbal(int verbalIndex, int explainIndex) {
    String vocabulary = vocabularyList.get(verbalIndex)[VocabularyEnum.ENG_1.ordinal()];
    if (explainInTimeCheckBox.isSelected()) {
      showVerbalLabel.setText(vocabulary);
      showExplainLabel.setText(vocabularyList.get(explainIndex)[VocabularyEnum.CHINESE_1.ordinal()]);
      ...
      showVerbalLabel.setText(vocabularyList.get(verbalIndex)[VocabularyEnum.ENG_1.ordinal()]);
      showExplainLabel.setText(vocabularyList.get(explainIndex)[VocabularyEnum.CHINESE_1.ordinal()]);
    }
    // 顯示目前已播放字彙數和字彙總量
    statusMessageLabel.setText(String.valueOf((verbalIndex + 1)).concat("/").concat(String.valueOf(vocabularyList.size())));
  }
  ...
  private void setForgetButtonText() {
    ...
    vocabularyList = databaseTool.getAllVacabulary((String) unitCombobox.getSelectedItem(), forgetCheckBox.isSelected());
  ...
  private void startButtonActionPerformed(ActionEvent evt) {// GEN-FIRST:event_startButtonActionPerformed
    ...
    int startIndex = Integer.parseInt(startSpinner.getValue().toString()) - 1;
  ...
  private void forgetButtonActionPerformed(ActionEvent evt) {// GEN-FIRST:event_forgetButtonActionPerformed
    ...
    for (int index = 0, end = vocabularyList.size(); index < end; index++) {
      String vocabulary = vocabularyList.get(index)[VocabularyEnum.ENG_1.ordinal()];
    ...
    if (null != word) {
      databaseTool.updateVocabularyMemoState((String) unitCombobox.getSelectedItem(), word, memoState);
    }
  ...
  private void initialState() {
    ...
    showVerbalLabel.setText("單字");
    showExplainLabel.setText("字義");
    pauseButton.setText("暫停");
  ...
  private void setForgetfulCheckboxState() {
    boolean isEnable = databaseTool.hasForgetfulVocabulary((String) unitCombobox.getSelectedItem());
  ...
  class VerbalWorker extends SwingWorker {
    ...
    protected Object doInBackground() throws Exception {
      while (!isCancelled()) {
        ...
        if (explainInTimeCheckBox.isSelected()) {
          showExplainLabel.setText(vocabularyList.get(index)[VocabularyEnum.CHINESE_1.ordinal()]);
          // Text to speech
          if (voiceCheckbox.isSelected()) {
            voice.play(vocabulary);
          }
  ...
  private JMenuItem addUnitMenuItem;
  ...
  // Database Object
  private transient final DataBaseTool databaseTool = AccessDataBaseTool.getAccessDataBaseTool();
  ...
  private JDialog addUnitBox;
  private JDialog configurationBox;
  private JDialog deleteUnitBox;
}
