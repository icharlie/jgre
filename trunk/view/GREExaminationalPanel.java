...
public class GREExaminationalPanel extends javax.swing.JPanel {
	...
	protected void setErrorCheckBoxState() {
		...
		if (examTypeComboBox.getSelectedIndex() == ExamTypesEnum.ANTONYM
				.ordinal()) {
			hasError = dbTool.hasErrorAnatonym(unit);
		} else if (examTypeComboBox.getSelectedIndex() == ExamTypesEnum.ANTONYM
				.ordinal()) {
	...
	private int getEnd(String unit) {
		if (examTypeComboBox.getSelectedIndex() == ExamTypesEnum.ANTONYM
				.ordinal()) {
			return dbTool.getAllAntonym(unit.toString(),
					errorCheckBox.isSelected()).size();
		} else if (examTypeComboBox.getSelectedIndex() == ExamTypesEnum.ANALOGY
				.ordinal()) {
			return dbTool.getAllAnalogy(unit.toString(),
					errorCheckBox.isSelected()).size();
		} else {
			return dbTool.getAllVacabulary(unit.toString(), false,
					errorCheckBox.isSelected()).size();
		}
	}
	...
	private void getNextQuestion() {
		...
		if (examTypeComboBox.getSelectedIndex() == ExamTypesEnum.VOCABULARY
				.ordinal()) {
		...
		Enumeration<AbstractButton> buttonEnum = optionsButtonGroup
				.getElements();
	...
	private boolean isLastQuestion() {
		return Integer.parseInt(totalCountLabel.getText()) == Integer
				.parseInt(finishedCountLabel.getText());
	}
	...
	private void prepareAntonymQuestions(QuestionGenerator questionGenerator) {
		...
		if (rangeComboBox.getSelectedIndex() == 0) {
			questions = questionGenerator.generateAntonymQuestions(unit,
					errorCheckBox.isSelected());
		} else if (rangeComboBox.getSelectedIndex() == 1) {
			String alph = alphabetComboBox.getSelectedItem().toString();
			questions = questionGenerator.generateAntonymQuestionsByAlphabet(
					unit, alph, errorCheckBox.isSelected());
		} else {
			int start = Integer.parseInt(serialStartSpinner.getValue()
					.toString());
			int end = Integer.parseInt(serialEndSpinner.getValue().toString());
			questions = questionGenerator.generateAntonymQuestionsByRange(unit,
					start - 1, end, errorCheckBox.isSelected());
		}
	...
	private void prepareAnalogyQuestions(QuestionGenerator questionGenerator) {
		...
		String unit = unitComboBox.getSelectedItem().toString();
		if (rangeComboBox.getSelectedIndex() == 0) {
			questions = questionGenerator.generateAnalogyQuestions(unit,
					errorCheckBox.isSelected());
		} else if (rangeComboBox.getSelectedIndex() == 1) {
			String alph = alphabetComboBox.getSelectedItem().toString();
			questions = questionGenerator.generateAnalogyQuestionsByAlphabet(
					unit, alph, errorCheckBox.isSelected());
		} else {
			int start = Integer.parseInt(serialStartSpinner.getValue()
					.toString());
			int end = Integer.parseInt(serialEndSpinner.getValue().toString());
			questions = questionGenerator.generateAnalogyQuestionsByRange(unit,
					start - 1, end, errorCheckBox.isSelected());
		}
		if (randomCheckBox.isSelected()) {
			questions = Utility.randomList(questions);
	...
	private void prepareVocabularyQuestions(QuestionGenerator qGenerator)
		...
		if (rangeComboBox.getSelectedIndex() == 0) {
			...
			questions = qGenerator.generateVocabularyQuestionsByAlphabet(unit,
					alphabetComboBox.getSelectedItem().toString(), isError);
		} else {
			int start = Integer.parseInt(serialStartSpinner.getValue()
					.toString());
			int end = Integer.parseInt(serialEndSpinner.getValue().toString());
			questions = qGenerator.generateVocabularyQuestionsByRange(unit,
					start - 1, end, isError);
		}
		if (randomCheckBox.isSelected()) {
			questions = Utility.randomList(questions);
	...
	private void setAnswerState() {
		...
		finishedCountLabel.setText(String.valueOf(questionGroup
				.getFininshedCount()));
		remainCountLabel
				.setText(String.valueOf(questionGroup.getRemainCount()));
		accurateCountLabel.setText(String.valueOf(questionGroup
				.getAccurateCount()));
		wrongCountLabel.setText(String.valueOf(questionGroup.getWrongCount()));
		accurateRateNumberLabel.setText(String.valueOf(
				questionGroup.getAccurateRate()).concat("%"));
	}
	...
	private void initComponents() {
		...
		String[] examTypes = new String[] {
				ExamTypesEnum.ANTONYM.getTypeName(),
				ExamTypesEnum.ANALOGY.getTypeName(),
				ExamTypesEnum.VOCABULARY.getTypeName() };
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				.getInstance(gre.view.GREApp.class).getContext()
				.getResourceMap(GREExaminationalPanel.class);
		...
		examTypeComboBox.setModel(new javax.swing.DefaultComboBoxModel(
				examTypes));
		...
		rangeComboBox.setModel(new javax.swing.DefaultComboBoxModel(
				new String[] { "全部", "依字母", "依編號" }));
		...
		alphabetComboBox.setModel(new javax.swing.DefaultComboBoxModel(
		...
		examPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
				resourceMap.getString("examPanel.border.title"),
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION, resourceMap
						.getFont("examPanel.border.titleFont"), resourceMap
						.getColor("examPanel.border.titleColor"))); // NOI18N
		...
		answerStatePanel
				.setBorder(javax.swing.BorderFactory
						.createTitledBorder(
								null,
								resourceMap
										.getString("answerStatePanel.border.title"),
								javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
								javax.swing.border.TitledBorder.DEFAULT_POSITION,
								resourceMap
										.getFont("answerStatePanel.border.titleFont"),
								resourceMap
										.getColor("answerStatePanel.border.titleColor"))); // NOI18N
		...
		finishedCountLabel.setText(resourceMap
				.getString("finishedCountLabel.text")); // NOI18N
		...
		remainCountLabel
				.setText(resourceMap.getString("remainCountLabel.text")); // NOI18N
		...
		accurateCountLabel.setText(resourceMap
				.getString("accurateCountLabel.text")); // NOI18N
		...
		accurateRateLabel.setText(resourceMap
				.getString("accurateRateLabel.text")); // NOI18N
		...
		accurateRateNumberLabel.setText(resourceMap
				.getString("accurateRateNumberLabel.text")); // NOI18N
		accurateRateNumberLabel.setName("accurateRateNumberLabel"); // NOI18N

		org.jdesktop.layout.GroupLayout answerStatePanelLayout = new org.jdesktop.layout.GroupLayout(
				answerStatePanel);
		answerStatePanel.setLayout(answerStatePanelLayout);
		answerStatePanelLayout
				.setHorizontalGroup(answerStatePanelLayout
						.createParallelGroup(
														...
														.add(
																answerStatePanelLayout
																		...
																		.add(
																				...
																				24)
																		.add(
																				accurateRateNumberLabel,
																				org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
																				65,
																				org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
										.addContainerGap()));
		answerStatePanelLayout
				.setVerticalGroup(answerStatePanelLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(
								answerStatePanelLayout
		...
		answerStatePanelLayout.linkSize(new java.awt.Component[] {
				accurateCountLabel, accurateLabel, accurateRateLabel,
				accurateRateNumberLabel, finishedCountLabel, finishedLabel,
				remainCountLabel, remainLabel, totalCountLabel, totalLabel,
				wrongCountLabel, wrongLabel },
				org.jdesktop.layout.GroupLayout.VERTICAL);

		questionPanel.setName("questionPanel"); // NOI18N

		questionEnglishLable.setFont(resourceMap
				.getFont("questionEnglishLable.font")); // NOI18N
		questionEnglishLable.setText(resourceMap
				.getString("questionEnglishLable.text")); // NOI18N
		questionEnglishLable.setName("questionEnglishLable"); // NOI18N

		questionChineseLabel.setFont(resourceMap
				.getFont("questionChineseLabel.font")); // NOI18N
		questionChineseLabel.setText(resourceMap
				.getString("questionChineseLabel.text")); // NOI18N
		questionChineseLabel.setName("questionChineseLabel"); // NOI18N

		optionsButtonGroup.add(optionOneRadioButton);
		optionOneRadioButton.setFont(resourceMap
				.getFont("optionOneRadioButton.font")); // NOI18N
		optionOneRadioButton.setText(resourceMap
				.getString("optionOneRadioButton.text")); // NOI18N
		optionOneRadioButton.setActionCommand(resourceMap
				.getString("optionOneRadioButton.actionCommand")); // NOI18N
		...
		optionTwoRadioButton.setFont(resourceMap
				.getFont("optionTwoRadioButton.font")); // NOI18N
		optionTwoRadioButton.setText(resourceMap
				.getString("optionTwoRadioButton.text")); // NOI18N
		optionTwoRadioButton.setActionCommand(resourceMap
				.getString("optionTwoRadioButton.actionCommand")); // NOI18N
		...
		optionThreeRadioButton.setFont(resourceMap
				.getFont("optionTwoRadioButton.font")); // NOI18N
		optionThreeRadioButton.setText(resourceMap
				.getString("optionThreeRadioButton.text")); // NOI18N
		optionThreeRadioButton.setActionCommand(resourceMap
				.getString("optionThreeRadioButton.actionCommand")); // NOI18N
		...
		optionFourRadioButton.setFont(resourceMap
				.getFont("optionTwoRadioButton.font")); // NOI18N
		optionFourRadioButton.setText(resourceMap
				.getString("optionFourRadioButton.text")); // NOI18N
		optionFourRadioButton.setActionCommand(resourceMap
				.getString("optionFourRadioButton.actionCommand")); // NOI18N
		...
		optionFiveRadioButton.setFont(resourceMap
				.getFont("optionTwoRadioButton.font")); // NOI18N
		optionFiveRadioButton.setText(resourceMap
				.getString("optionFiveRadioButton.text")); // NOI18N
		optionFiveRadioButton.setActionCommand(resourceMap
				.getString("optionFiveRadioButton.actionCommand")); // NOI18N
		...
		org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings
				.createAutoBinding(
						...
						hiddenButton, org.jdesktop.beansbinding.ELProperty
								.create("${!selected}"), confirmButton,
		...
		org.jdesktop.layout.GroupLayout questionPanelLayout = new org.jdesktop.layout.GroupLayout(
				questionPanel);
		questionPanel.setLayout(questionPanelLayout);
		questionPanelLayout
				.setHorizontalGroup(questionPanelLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(
								questionPanelLayout
		...
		questionPanelLayout
				.setVerticalGroup(questionPanelLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(
								questionPanelLayout
		...
		org.jdesktop.layout.GroupLayout examPanelLayout = new org.jdesktop.layout.GroupLayout(
				examPanel);
		examPanel.setLayout(examPanelLayout);
		examPanelLayout
				.setHorizontalGroup(examPanelLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						...
						.add(
								...
								examPanelLayout
										...
										.add(
												...
												org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
												org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)));
		examPanelLayout.setVerticalGroup(examPanelLayout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				examPanelLayout.createSequentialGroup().add(answerStatePanel,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(
		...
		layout.linkSize(new java.awt.Component[] { errorCheckBox,
				examTypeComboBox, examTypeLabel, letterLable, rangeComboBox,
				rangeLabel, serialEndSpinner, serialLabel, serialStartSpinner,
				startButton, stopButton, toLabel, unitComboBox, unitLabel },
				org.jdesktop.layout.GroupLayout.VERTICAL);
	...
	private void rangeComboBoxActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_rangeComboBoxActionPerformed
		if (rangeComboBox.getSelectedIndex() == RangeTypeEnum.ALL.ordinal()) {
			...
			serialStartSpinner.setEnabled(false);
			serialEndSpinner.setEnabled(false);
		} else if (rangeComboBox.getSelectedIndex() == RangeTypeEnum.ALPHABET
				.ordinal()) {
	...
	private void setSerialState() {
		if (rangeComboBox.getSelectedIndex() == RangeTypeEnum.SERAIL_NUMBER
				.ordinal()) {
	...
	private void confirmButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_confirmButtonActionPerformed
		...
		if (examTypeIndex != ExamTypesEnum.VOCABULARY.ordinal()) {
			...
			optionOneRadioButton.setText(nowQuestion.getOptionOneEnglish()
					.concat("(").concat(nowQuestion.getOptionOneChinese())
					.concat(")"));
			optionTwoRadioButton.setText(nowQuestion.getOptionTwoEnglish()
					.concat("(").concat(nowQuestion.getOptionTwoChinese())
					.concat(")"));
			optionThreeRadioButton.setText(nowQuestion.getOptionThreeEnglish()
					.concat("(").concat(nowQuestion.getOptionThreeChinese())
					.concat(")"));
			optionFourRadioButton.setText(nowQuestion.getOptionFourEnglish()
					.concat("(").concat(nowQuestion.getOptionFourChinese())
					.concat(")"));
			optionFiveRadioButton.setText(nowQuestion.getOptionFiveEnglish()
					.concat("(").concat(nowQuestion.getOptionFiveChinese())
					.concat(")"));
		}
	...
	private int getOptionsSelectedIndex() {
		int index = -1;
		Enumeration<AbstractButton> buttonsEnum = optionsButtonGroup
				.getElements();
	...
	private transient DataBaseTool dbTool = AccessDataBaseTool
