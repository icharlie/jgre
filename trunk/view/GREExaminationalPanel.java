...
public class GREExaminationalPanel extends javax.swing.JPanel {
  ...
  private void getNextQuestion() {
    ...
    isUppCase = uppCaseCheckBox.isSelected();
    String question = nowQuestion.getQuestionEnglish();
    questionEnglishLable.setText(isUppCase ? question.toUpperCase() : question);
    ...
    if (examTypeComboBox.getSelectedIndex() == ExamTypesEnum.VOCABULARY.ordinal()) {
      ...
      String optionOne = nowQuestion.getOptionOneEnglish();
      String optionTwo = nowQuestion.getOptionTwoEnglish();
      String optionThree = nowQuestion.getOptionThreeEnglish();
      String optionFour = nowQuestion.getOptionFourEnglish();
      String optionFive = nowQuestion.getOptionFiveEnglish();
      optionOneRadioButton.setText(isUppCase ? optionOne.toUpperCase() : optionOne);
      optionTwoRadioButton.setText(isUppCase ? optionTwo.toUpperCase() : optionTwo);
      optionThreeRadioButton.setText(isUppCase ? optionThree.toUpperCase() : optionThree);
      optionFourRadioButton.setText(isUppCase ? optionFour.toUpperCase() : optionFour);
      optionFiveRadioButton.setText(isUppCase ? optionFive.toUpperCase() : optionFive);
    }
  ...
  private void initComponents() {
    ...
    uppCaseCheckBox = new javax.swing.JCheckBox();

    setName("Form"); // NOI18N

    org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(GREExaminationalPanel.class);
    ...
    uppCaseCheckBox.setFont(resourceMap.getFont("uppCaseCheckBox.font")); // NOI18N
    uppCaseCheckBox.setText(resourceMap.getString("uppCaseCheckBox.text")); // NOI18N
    uppCaseCheckBox.setName("uppCaseCheckBox"); // NOI18N
  ...
  private void confirmButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_confirmButtonActionPerformed
    ...
    if (examTypeIndex != ExamTypesEnum.VOCABULARY.ordinal()) {
      ...
      optionOneRadioButton.setText((isUppCase ? optionOne.toUpperCase() : optionOne).concat("(").concat(nowQuestion.getOptionOneChinese()).concat(")"));
      optionTwoRadioButton.setText((isUppCase ? optionTwo.toUpperCase() : optionTwo).concat("(").concat(nowQuestion.getOptionTwoChinese()).concat(")"));
      optionThreeRadioButton.setText((isUppCase ? optionThree.toUpperCase() : optionThree).concat("(").concat(nowQuestion.getOptionThreeChinese()).concat(")"));
      optionFourRadioButton.setText((isUppCase ? optionFour.toUpperCase() : optionFour).concat("(").concat(nowQuestion.getOptionFourChinese()).concat(")"));
      optionFiveRadioButton.setText((isUppCase ? optionFive.toUpperCase() : optionFive).concat("(").concat(nowQuestion.getOptionFiveChinese()).concat(")"));
    }
  ...
  private javax.swing.JCheckBox uppCaseCheckBox;
  ...
  private boolean isUppCase = false;
}
